...
import { ANONYMOUS_USER, HTML_CODE_WARNING, PRIMARY_BUTTON, 
    SECONDARY_BUTTON, MIN_SHOW_COMMENT_BTN_LENGTH,} from '~/utils/constants';
import * as Styled from './CommentInput.styled';
import Button from '~/components/Atoms/Button';
import { deleteNoMarkupFormatHTML } from '~/utils/stringOperations';
import CommentInputAuthor from '~/components/CommentInput/CommentInputAuthor';
