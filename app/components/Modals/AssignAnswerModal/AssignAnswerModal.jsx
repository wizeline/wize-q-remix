...
import { DISABLED_BUTTON, SECONDARY_BUTTON, CLOSE_BUTTON, DEPARTMENT_PLACEHOLDER } from '~/utils/constants';
import { ACTIONS } from '~/utils/actions';
import * as Styled from '~/components/Modals/AssignAnswerModal/AssignAnswerModal.Styled'
...
function AssignAnswerModal(props) {
  ...
  const renderDepartmentOptions = () =>
    departmentData.map(department2 =>
  ...
  const renderDepartmentSelectBox = () => (
    <FormGroup controlId="formControlsSelectMultiple">
      <ControlLabel>Specify which department you think your question
        should be addressed to:</ControlLabel>
    ...
    <div id="main" onClick={resetModal}>
      <Styled.AssignModal show>
        <Styled.AssignModalDialog onClick={e => e.stopPropagation()}>
          ...
          <Styled.ModalHeader>
            <Styled.ModalTitle>
                Reassign question Q{question.question_id}
            </Styled.ModalTitle>
          </Styled.ModalHeader>
          <Styled.ModalBody>
