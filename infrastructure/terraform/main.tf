module "cloud_run" {
  ...
  db_url         = "mysql://${data.google_secret_manager_secret_version.Db_user.secret_data}:${data.google_secret_manager_secret_version.Db_password.secret_data}@${data.google_secret_manager_secret_version.Db_host.secret_data}/${data.google_secret_manager_secret_version.Db_name.secret_data}"
